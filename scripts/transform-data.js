...
// src/windows-1254.src.mjs → windows-1254.mjs
const LIB_TEMPLATE = fs.readFileSync('./src/windows-1254.src.mjs', 'utf8');
const createLib = template(LIB_TEMPLATE, TEMPLATE_OPTIONS);
const libCode = createLib(require('./export-data.js'));
fs.writeFileSync('./windows-1254.mjs', libCode);

// src/windows-1254.d.ts → windows-1254.d.ts
const TYPES_TEMPLATE = fs.readFileSync('./src/windows-1254.d.ts', 'utf8');
const createTypes = template(TYPES_TEMPLATE, TEMPLATE_OPTIONS);
const typesCode = createTypes(require('./export-data.js'));
fs.writeFileSync('./windows-1254.d.ts', typesCode);
